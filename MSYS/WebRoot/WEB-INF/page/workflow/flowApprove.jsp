...
<head>
	...
	<script type="text/javascript">
		function saveInfo(flag){
			 document.Form1.action="workflow/elecApplicationFlowAction_approve.do";
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
			        ...
			        <td class="ta_01" bgColor="#ffffff" colspan="3">
			        	<a id="elecApplicationFlowAction_approve_" href="${pageContext.request.contextPath }/workflow/elecApplicationFlowAction_download.do?applicationID=2" style="text-decoration: underline">[点击下载申请文件]</a>
			        </td>
				</tr>
					<tr>
						<td align="center" bgColor="#f5fafe" class="ta_01" width="20%">请选择下一步：<font color="#FF0000">*</font></td>
				        <td class="ta_01" bgColor="#ffffff" colspan="3">
				        	<select name="outcome" id="elecApplicationFlowAction_approve_outcome">
