...
<link href="${pageContext.request.contextPath }/css/Style.css" type="text/css" rel="stylesheet">
  ...
  <script language="javascript"> 
   function checkchar(){
  document.Form1.action="system/testsAction_save.action";
...
<!-- <form  action="${pageContext.request.contextPath}/testsAction_save.action"  method="post"> -->
...
<!-- 			<input type="submit" name="BT_Submit" value="保存"  id="BT_Submit" style="font-size:12px; color:black; height=20;width=50"> -->
